...
A fully customized, bare-metal **Snake Game** implemented on the **ATmega32** microcontroller using C and Layered Software Architecture. The system utilizes an **8x8 / 16x16 LED Dot Matrix** driven by **74HC595 Shift Registers**, featuring a custom Real-Time Cooperative Scheduler and serial input control.

---

## 📸 Project Demo
> Add a picture or GIF of your running hardware setup here:
> `![Snake Game Hardware Setup](docs/demo.gif)`
...
* **Shift Register Multiplexing:** Utilizes **74HC595 Shift Registers** to drive the LED Dot Matrix while conserving microcontroller I/O pins.
...
│   └── SHIFT_REG/          # 74HC595 Shift Register Driver
│
...
* **Shift Registers:** 74HC595 (Serial-In Parallel-Out)
...
| --- | --- | --- |
| **74HC595 Data** | PORTA Pin 0 | DS (Serial Data) |
| **74HC595 Shift Clock** | PORTA Pin 1 | SH_CP (Shift Clock) |
| **74HC595 Latch Clock** | PORTA Pin 2 | ST_CP (Storage/Latch Clock) |
...
```bash
git clone [https://github.com/YOUR_GITHUB_USERNAME/SNAKE_GAME.git](https://github.com/YOUR_GITHUB_USERNAME/SNAKE_GAME.git)
...
* **Mazen Mohammed Said** - *Embedded Systems Developer* - [GitHub Profile](https://www.google.com/search?q=https://github.com/YOUR_GITHUB_USERNAME&utm_source=gemini)
* **Mohamed Hesham Mohamed** - *Embedded Systems Developer* - [GitHub Profile](https://www.google.com/search?q=https://github.com/FRIEND_GITHUB_USERNAME&utm_source=gemini)
